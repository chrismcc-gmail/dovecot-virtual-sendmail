...
dnl FEATURE(blocklist_recipients)dnl
...
dnl DAEMON_OPTIONS(`Port=smtp, Name=MTA-v4')dnl
dnl #
...
dnl DAEMON_OPTIONS(`port=smtps, Name=MTA-v6, Family=inet6')dnl
dnl #
...
define(`LOCAL_MAILER_PATH',`/usr/libexec/dovecot/dovecot-lda')
define(`LOCAL_MAILER_ARGS', `/usr/libexec/dovecot/dovecot-lda -d $u')dnl
...
define(`confMILTER_MACROS_CONNECT',`t, b, j, _, {daemon_name},{daemon_port} {if_name}, {if_addr},{client_addr}')dnl
...
define(`confMILTER_MACROS_ENVRCPT',`r, v, Z, {rcpt_mailer}, {rcpt_host}, {rcpt_addr}, {greylist}')dnl

define(`confFORWARD_PATH', `')

dnl define(`confCACERT', `/etc/pki/ca-trust/extracted/pem/tls-ca-bundle.pem')
dnl define(`confSERVER_CERT', `/etc/letsencrypt/live/example.com/fullchain.pem')
dnl define(`confSERVER_KEY', `/etc/letsencrypt/live/example.com.net/privkey.pem')
